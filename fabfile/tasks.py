...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(os.path.dirname(__file__)), 'bmsxmlrpc')))  # noqa:E402
...
def push_docs(path=None):
    ...
    # Making assumptions
    WEB_ROOT = path if path is not None else os.path.join('var', 'www', 'html', 'bmsxmlrpc', 'en', 'latest')
